...
msg -bar
msg -tit
echo -e "${cor[3]}  SHADOWSOCK-LIBEV+(obfs) INSTALLER By @Kalix1"
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/sh13y/VPS-MX-English/main/libraries/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
